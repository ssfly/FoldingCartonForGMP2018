...
{\color{blue}{If two faces $f_a$ and $f_b$ need to snap together, the whole vertexes of these two faces should satisfy the coplanarity constrain.}}
...
Combining the above constraints, the new vertex locations can be solved \cxj{XX method, cite the paper.}{\color{blue}{by minimizing the proximity function based on projection operators\cite{Bouaziz:2012:SSD:2346796.2346802}.}}
%
