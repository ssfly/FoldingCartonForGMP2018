...
The automatic folding part automatically computes the 3D coordinates of vertexes in cartons based on simple observation. Then the suggestive editing part smartly provides a group of geometric constraints, such as vertex merging, merging propagation, and panel pasting, for users to manipulate 3D shapes.
Moreover, automatic updating of 2D layouts is supported when the user constructs and edits the carton shape in 3D to correct and explore layouts.  
\end{abstract}
